            ...
            <table class="table table-condensed">
                ...
                <tr data-ng-repeat="product in cart.data">
                    <td class="cart_product">
                        <a href=""><img data-ng-src="<%product.image_location%>"
                                        style="height:40px;width:40px;padding:0px 0px 0px;" alt="product image"></a>
                    </td>
                    ...
                    <td colspan="2">
                        <table class="table table-condensed total-result">
                            <tr>
                                ...
                                <td><span>₦ <span data-ng-bind="cart.total_price"></span></span></td>
                            </tr>
                            <tr>
                                <td>Exo Tax</td>
                                <td>₦ 0</td>
